...
if (rst_i)begin
 cfg_arready_reg  <= 1'b0;
 cfg_awready_reg  <= 1'b0;//~cfg_bvalid_o && ~cfg_arvalid_i; 
 cfg_wready_reg   <= 1'b0;//cfg_awready_o;
 end
    else begin
 cfg_arready_reg  <= cfg_arvalid_i;
 cfg_awready_reg  <= cfg_awvalid_i;//~cfg_bvalid_o && ~cfg_arvalid_i; 
 cfg_wready_reg   <= cfg_awvalid_i;//cfg_awready_o;
end
end

assign cfg_arready_o = cfg_arready_reg;
assign cfg_awready_o = cfg_awready_reg; 
assign cfg_wready_o  = cfg_wready_reg;
